...
window.addEventListener("DOMContentLoaded", function () {
  let nomeElemento = this.localStorage.getItem("nomeElemento");
  let preçoElemento = this.localStorage.getItem("preçoElemento");
  let imagemElemento = this.localStorage.getItem("imagemElemento");
  ...
  let nomeProduto = this.document.getElementById("nomeProduto");
  nomeProduto.innerHTML = nomeElemento;

  let containerImg = this.document.getElementById("containerImg");
  let img = this.document.createElement("img");
  img.setAttribute("src", imagemElemento);
  containerImg.insertBefore(img, containerImg.firstChild);
  ...
  let preçoElementoHtml = this.document.getElementById("preçoProduto");
  preçoElementoHtml.innerHTML = preçoElemento;
